      ...
      <main className="main-content">
        ...
        <header className="top-header">
          <div>
            ...
            <p>
              Take a deep breath. You’re in a
              safe space.
            </p>
          </div>
            ...
            {filteredPosts.map(
              (post) => (
                ...
                >
                  ...
                  <div
                    className={`post-avatar ${post.avatar}`}
                  />
          ...
          <div className="story-list">
            ...
            {stories.map(
              (story, index) => (
                ...
                >
                  <div
                    className={`story-image ${story.image}`}
                  />
      ...
      <aside className="right-panel">
        ...
        <section className="quick card">
          ...
          <QuickRow
            icon={<Heart />}
            title="Read Stories"
            subtitle="Real experiences, real people"
          />
        </section>
